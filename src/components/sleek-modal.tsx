// Sleek Modal v1.0.0 By Hussein Kizz
 ...
 * @property {Function} onClose - Function to call when the modal needs to close.
 * @property {boolean} [disableClickOutside] - Optional prop to disable clicking outside the modal to close it. Defaults to false.
 * @property {('xs'|'sm'|'md'|'lg')} [size] - Optional prop to set the size of the modal. Defaults to 'w-4/5'.
 * @property {JSX.Element | JSX.Element[]} children - Children elements to render inside the modal.
 */
...
export default function SleekModal(props: Props) {
  ...
  return (
    <section
      className={`${
        props.isOpen ? "absolute z-40 flex w-full flex-auto" : "hidden"
      }`}
    >
